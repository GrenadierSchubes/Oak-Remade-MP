...
NCountry = {
	...
	AIR_SCORE_MULTIPLIER = 0,							-- Based on number of planes 
...
NNavy = {
	...
	SCREENING_EFFICIENCY_PENALTY_ON_MINIMUM_POSITIONING				= 0.50,  -- screening efficiency (screen to capital ratio) at 0% positioning
